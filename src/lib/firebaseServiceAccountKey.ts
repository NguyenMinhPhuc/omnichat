...
if (!getApps().some((app) => app.name === appName)) {
  app = initializeApp({
    // By replacing the escaped newlines, we ensure the key is correctly formatted.
    credential: cert(JSON.parse(JSON.stringify(serviceAccount).replace(/\\n/g, '\n'))),
