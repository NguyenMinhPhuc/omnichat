...
if (!getApps().some((app) => app.name === appName)) {
  // Parse the service account object to ensure it's a valid JSON format before passing to cert()
  const serviceAccountJson = JSON.parse(JSON.stringify(serviceAccount));
  app = initializeApp({
